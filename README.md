...
<head>
    ...
    <!-- Expanded Premium Fonts Collection -->
    <link href="https://fonts.googleapis.com/css2?family=Anton&family=Montserrat:ital,wght@0,500;0,600;0,800;0,900;1,500;1,900&family=Oswald:wght@500;700&family=Playfair+Display:ital,wght@0,700;1,700&family=Impact&family=Roboto:wght@400;700;900&family=Bebas+Neue&family=Lora:ital,wght@0,700;1,700&family=Merriweather:wght@700;900&display=swap" rel="stylesheet">
    
    <style>
        /* ==========================================================================
           INDIA GLOBALCINE - ADVANCED PREMIUM CSS (ULTIMATE EDITION)
           ========================================================================== */
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .editor-sidebar {
            width: 480px; /* Widened for more controls */
        ...
        .file-upload-wrapper {
            position: relative; width: 100%; height: 60px; border: 2px dashed #555;
            border-radius: 4px; display: flex; align-items: center; justify-content: center;
            cursor: pointer; background: #1a1a1a; transition: all 0.3s ease; margin-bottom: 10px;
        }
        ...
        .btn {
            width: 100%; padding: 16px; border: none; border-radius: 6px; font-size: 15px;
        ...
        input[type=color] { width: 40px; border: 1px solid #555; border-radius: 4px; background: #111; cursor: pointer; height: auto; padding: 2px; }
        ...
        .theme-global-blur { background: linear-gradient(to bottom, #000000 0%, rgba(0,0,0,0.9) 45%, transparent 100%) !important; }

        /* --- THEMES (1-7 ORIGINALS) --- */
        .post-header-area {
            background-color: #ffffff; padding: 45px 30px 20px 30px; z-index: 5;
            position: relative; display: flex; flex-direction: column; align-items: center;
            width: 100%; overflow: hidden; 
        }
        .main-breaking { font-family: 'Impact', sans-serif; font-size: 215px; line-height: 0.8; color: #000; text-transform: uppercase; text-align: center; margin-bottom: 35px; letter-spacing: -1px; white-space: nowrap; transform: scale(1.25, 1.3); }
        .sub-headline { font-family: 'Montserrat', sans-serif; font-weight: 900; font-size: 50px; line-height: 1.25; color: #000; text-transform: uppercase; text-align: center; width: 95%; }
        ...
        /* ==========================================================================
           BRAND NEW THEMES (8-16) FROM SCREENSHOTS
           ========================================================================== */
        
        /* THEME 8: Fact/History (Time4Media style) */
        ...
        /* THEME 9: Political Quote (IND Vibe style) */
        ...
        /* THEME 10: Financial Alert (ShareSanskar style) */
        ...
        /* THEME 11: Comedy/Headline (Zilha Parishad style) */
        ...
        /* THEME 12: War Room / Documentary (Daily Rawalpindi style) */
        ...
        /* THEME 13: Center Impact (One Vision Media style) */
        ...
        /* THEME 14: Shocking Reveal (Hindu Gurukul style) */
        ...
        /* THEME 15: News Footer (NBT style) */
        ...
        /* THEME 16: Top Header (Desh style) */
        ...
        .date-box { position: absolute; bottom: 30px; left: 30px; background-color: var(--news-red); color: white; padding: 10px 25px; text-align: center; display: flex; flex-direction: column; align-items: center; justify-content: center; }
...
<body>
        ...
        <div class="control-group-container">
            ...
            <div class="control-group" style="background: #2a2a2a; border-left: 4px solid #ffcc00;">
                ...
                <select id="layout-selector" class="form-control" style="background: #000; border: 1px solid #555; padding: 15px; font-size: 16px;">
                    ...
                    <optgroup label="New Advanced Layouts (From Uploads)">
                        <option value="theme-t8">Layout 8: Fact / History (Time4Media)</option>
                        <option value="theme-t9">Layout 9: Political Quote (IND Vibe)</option>
                        <option value="theme-t10">Layout 10: Financial Alert (ShareSanskar)</option>
                        <option value="theme-t11">Layout 11: Headline Meme (Comedy)</option>
                        <option value="theme-t12">Layout 12: War Room Doc (Rawalpindi)</option>
                        <option value="theme-t13">Layout 13: Center Impact (One Vision)</option>
                        <option value="theme-t14">Layout 14: Shocking Reveal (Gurukul)</option>
                        <option value="theme-t15">Layout 15: News Footer Curve (NBT)</option>
                        <option value="theme-t16">Layout 16: Top Header Story (Desh)</option>
                    </optgroup>
                </select>
            </div>
            ...
            <div class="control-group" style="background: #1a1a2e; border-left: 4px solid #00f0ff;">
                <label style="color: #00f0ff; font-size: 14px;">🖌️ ADVANCED MULTI-HIGHLIGHT SYSTEM</label>
                ...
                <div class="control-group">
                    ...
                    <div class="input-row">
                        <div class="input-stack">
                            ...
                            <select id="font-t2-yellow" class="font-selector"><option value="'Montserrat', sans-serif">Montserrat</option></select>
                        </div>
                ...
                <div class="control-group">
                    ...
                    <div class="input-row">
                        <div class="input-stack">
                            ...
                            <select id="font-t3-author" class="font-selector"><option value="'Montserrat', sans-serif">Montserrat</option></select>
                        </div>
                ...
                <div class="control-group">
                    ...
                    <div class="input-row">
                        <div class="input-stack">
                            ...
                            <select id="font-t6-top" class="font-selector"><option value="'Anton', sans-serif">Anton</option></select>
                        </div>
                        <div class="input-stack" style="flex:0.2;">
            ...
            <div class="control-group">
                <label>Upload Primary Logo</label>
                <div class="file-upload-wrapper">
            ...
            <div class="control-group" style="border-left: 4px solid #00cc44;">
                ...
                <div style="display: flex; flex-direction: column; gap: 12px; margin-top: 10px;">
                    ...
                    <div style="border-top: 1px solid #444; padding-top: 10px; margin-top: 5px;">
                        <label style="font-size:10px; color:#00f0ff; margin-bottom:2px;">Blur Overlay Coverage (Themes 1-7)</label>
                        <input type="range" id="slider-blur" min="0" max="1350" value="165">
                    </div>
                    <div>
                        <label style="font-size:10px; color:#00f0ff; margin-bottom:2px;">Gradient Overlay Opacity (All Themes)</label>
                        <input type="range" id="slider-opacity" min="0" max="100" value="95">
                    </div>
                </div>
            </div>
            ...
            <div id="post-canvas" class="instagram-post">
                ...
                <div id="zoom-wrapper" style="width: 100%; height: 100%; display: flex; flex-direction: column; transform: scale(1); transform-origin: center center; position:relative;">
                    ...
                    <div class="post-media-area" id="post-media-area">
                        ...
                        <div class="overlay-layer" id="overlays-global">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Helper function to bind text, color, and font to any element
            ...
            opacitySlider.addEventListener('input', (e) => {
                ...
                // Update opacity for specific gradients based on active theme
                const activeTheme = document.getElementById('layout-selector').value;
                if(activeTheme === 'theme-t9') document.getElementById('gradient-t9').style.opacity = val;
                if(activeTheme === 'theme-t12') document.getElementById('gradient-t12').style.opacity = val;
                if(activeTheme === 'theme-t16') document.getElementById('gradient-t16').style.opacity = val;
                blurDiv.style.opacity = val;
            });
